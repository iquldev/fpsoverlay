...
public class FPSOverlayConfig extends MidnightConfig {
    ...
    @Comment(category = "b", centered = true) public static Comment currentRamPlaceholder;
    @Comment(category = "b", centered = true) public static Comment maxRamPlaceholder;
    @Comment(category = "b", centered = true) public static Comment ramPercentPlaceholder;
    @Comment(category = "b", centered = true) public static Comment worldTimePlaceholder;
    @Comment(category = "b", centered = true) public static Comment weatherPlaceholder;
    @Comment(category = "b", centered = true) public static Comment sessionTimePlaceholder;
    ...
    @Comment(category = "c", centered = true) public static Comment currentRamAdvancedPlaceholder;
    @Comment(category = "c", centered = true) public static Comment maxRamAdvancedPlaceholder;
    @Comment(category = "c", centered = true) public static Comment ramPercentAdvancedPlaceholder;
    @Comment(category = "c", centered = true) public static Comment worldTimeAdvancedPlaceholder;
    @Comment(category = "c", centered = true) public static Comment weatherAdvancedPlaceholder;
    @Comment(category = "c", centered = true) public static Comment sessionTimeAdvancedPlaceholder;
